...
public class MealController {
    ...
    public MealController(MealService mealService, MealLogService mealLogService, UserService userService) {
    ...
    public Meal addNewMeal(@PathVariable String userId, @RequestBody MealPayload mealPayload){
        try{
            ...
            mealLogService.addMultipleMealLogs(mealPayload.getFoodItems(), mealToAdd);
